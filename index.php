            ...
            <ul class="glide__slides">
                ...
                <?php 
                    ...
                    foreach( $posts as $post ){
                        setup_postdata($post);
                        ?>
                        <li style="background-image: url('<?php the_field('slider-img'); ?>')" class="glide__slide">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-7 offset-1">
                                        <h2 
                                            style="
                                            <?php
                                            $field = get_field('slider-text_color');
                                            if ($field == 'white') {
                                                ?>
                                                    color: #fff
                                                <?php
                                        ...
                                        <?php
                                            $field = get_field('slider-btn');

                                            if ($field == 'on') {
                                                ?>
                                                    <a href="<?php the_field('slider-link') ?>" class="button">View details</a>
                                                <?php
                                            }
                                            ?>
            ...
            <div class="row">
                <div class="col-md-10 offset-md-1 col-lg-5 offset-lg-1">
                    <div class="about__img">
                        <img src="<?php the_field('about-img'); ?>" alt="about company">
                    </div>
                </div>
                <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-6 col-xl-5 offset-xl-1">
                    <h1 class="title underlined"><?php the_field('about-title'); ?></h1>
                    <div class="about__text">
                    <?php the_field('about-descr'); ?>
                    </div>
